                ...
                <table class="table align-items-center table-bordered">
                    ...
                    <tbody>
                        <?php
                                ...
                                $sql="select * from records,book,renew,user where user.email=records.email AND records.book_id=book.BookId AND renew.email=records.email AND renew.BookId=records.book_id order by borrowdate DESC";
                            ...
                            <tr>
                                ...
                                <?php
                                      if ($renewals > 0) {
                                        echo "<a href=\"accept_renew.php?id1=".$bookid."&id2=".$Email."\" class=\"btn btn-success\">Accept</a>";}
                                      
                                      ?>
                                      <a href="rejectrequest.php?id1=<?php echo $bookid ?>&id2=<?php echo $Email ?>" class="btn btn-danger">Reject</a>
                                </td>
                            </tr>
                            <?php }
                         ?>
