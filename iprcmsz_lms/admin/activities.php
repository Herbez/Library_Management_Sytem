                ...
                <table class="table align-items-center table-bordered">
                    ...
                    <tbody>
                        <?php
                                ...
                                $sql="select * from records,book, user where user.email=records.email AND records.book_id=book.BookId";
                            ...
                            <tr>
                                ...
                                <td>
                                    <b>
                                      <?php 
                                          if ($returndate === null && $Status == 'Accepted') {
                                            echo '<span class="text-danger">Not Yet returned</span>';
                                            }elseif ($returndate === null && $Status == 'Pending') {
                                                echo '<span class="text-warning">Book not yet taken</span>';
                                            }elseif ($returndate === null && $Status == 'Rejected') {
                                              echo '<span class="text-warning">Book not borrowed</span>';
                                            } 
                                            else {
                                                echo '<span class="text-primary">Returned On ' .$returndate.' </span>';
                                            }
                                      ?>
                                    </b>
                                </td>
                                <td><b> 
                                        <?php 
                                          ...
                                          if ($renewals === null) {
                                            echo '<span class="text-danger">No renewals</span>';
                                          } else {
                                            echo $renewals;
                                          }
                                    ...
                                    <b>
                                        <?php 
                                            if ($returndate<=$duedate){            
                                                ...
                                                echo '<span class="text-danger">'.$dues.'</span>';
                                            } 
                                        ?>
                                    </b>
                                </td>
