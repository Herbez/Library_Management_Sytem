            ...
            <?php
                ...
                <form>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name = "title" value="<?php echo $Title ?>" placeholder="Book Title" style="width: 600px;">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label  class="col-sm-3 col-form-label text-right">Year</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name = "year" value="<?php echo $Year ?>" placeholder="Year" style="width: 600px;">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label  class="col-sm-3 col-form-label text-right">Publisher</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name = "publisher" value="<?php echo $Publisher ?>" placeholder="Publisher" style="width: 600px;">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label  class="col-sm-3 col-form-label text-right">Number of copies</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name = "availability" value="<?php echo $Availability ?>" placeholder="Number of copies" style="width: 600px;">
                        </div>
                    </div>
...
if(isset($_POST['updatebook'])) {
    ...
    $sql="UPDATE book Set Title='$Title' ,Year='$Year' ,Publisher='$Publisher' ,Availability='$Availability' WHERE BookId=$bookid";
    
    if ($conn->query($sql) === TRUE) {
        echo 
            "<script type='text/javascript'> alert('Book Not Updated')
                window.location.href='allbook.php';
            </script>";
        exit(); // terminate script execution after redirection
    } else {
        echo "<script type='text/javascript'>alert('Book Not Updated')</script>";
        header("Refresh:0.01; url=allbook.php");
        exit(); // terminate script execution after redirection
    }
}
?>