            ...
            require('dbconn.php');
                if(isset($_POST['search']))
                    {$searchkey=$_POST['title'];
                        $sql="select * from user where type!='1' and names like '%$searchkey%'";
                    }
                else
                ...
                if (!($rowcount)) {
                    ...
                    echo '<p><strong><em>Sorry, no user were found.</em></strong></p>';
        ...
        <div class="col-md-6 mt-3 mb-3">
            <form class="custom-search-form" action="" method="post">
                <div class="input-group">
                    <input type="text" name="title" class="form-control custom-search-input" placeholder="Search for a user" style="border-color: #3f51b5; border-radius: 5px 0 0 5px;" required>
