                ...
                <table class="table align-items-center table-bordered">
                    ...
                    <tbody>
                        <?php
                                ...
                                $sql="select * from records,book, user where user.email=records.email AND Status ='Pending' And  records.book_id=book.BookId order by borrowdate DESC";
                            ...
                            <tr>
                                ...
                                <?php
                                      if ($Availability > 0) {
                                        echo "<a href=\"accept_request.php?id1=".$bookid."&id2=".$Email."\" class=\"btn btn-success\">Accept</a>";}
